...
@section('content')
    <div class="card card-primary">
        <form action="{{ route('back.admin.majors.update', $major->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('name', $major->name) }}" name="name" class="form-control"
