        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{ route('back.patient.home') }}"
                        class="nav-link {{ request()->is('back/patient/home') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{ route('back.patient.bookings.show') }}"
                        class="nav-link {{ request()->is('back/patient/bookings/') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-th"></i>
                        <p>
                            Bookings
                        </p>
